...
public class BuildSidebarViewComponent : ViewComponent
{
    private readonly IApplicationDbContext _context;
    public BuildSidebarViewComponent(IApplicationDbContext context)
    {
        _context = context;
    }
    ...
    {
        var html = await GenerateSidebarAsync(path, container);
        return new HtmlContentViewComponentResult(new HtmlString(html));
    }
    public async Task<string> GenerateSidebarAsync(string? path = null, bool container = true)
    {
