            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'id', title: 'ID'},
                        {field: 'title', title: 'Title', align: 'left', formatter: Controller.api.formatter.title},
                        {field: 'icon', title: 'Icon', formatter: Controller.api.formatter.icon},
                        {field: 'name', title: 'Name', align: 'left', formatter: Controller.api.formatter.name},
                        {field: 'weigh', title: 'Weigh'},
                        {field: 'status', title: 'Status', formatter: Table.api.formatter.status},
                        {
                            field: 'ismenu',
                            title: 'Ismenu',
                            align: 'center',
        ...
        api: {
            ...
            bindevent: function () {
                ...
                $(document).on('click', '#chooseicon ul li', function () {
                    $("input[name='icon']").val('fa fa-' + $(this).data("font")).trigger("change");
                    Layer.closeAll();
                });
