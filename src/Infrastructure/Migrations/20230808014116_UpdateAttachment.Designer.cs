...
namespace CasseroleX.Infrastructure.Migrations
{
    ...
    [Migration("20230808014116_UpdateAttachment")]
            ...
            modelBuilder.Entity("CasseroleX.Domain.Entities.AdminLog", b =>
                {
                    ...
                    b.Property<DateTime>("CreateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 8, 8, 9, 41, 16, 12, DateTimeKind.Local).AddTicks(6787))
                        .HasComment("操作时间");
            ...
            modelBuilder.Entity("CasseroleX.Domain.Entities.Attachment", b =>
                {
                    ...
                    b.Property<DateTime>("CreateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 8, 8, 9, 41, 16, 17, DateTimeKind.Local).AddTicks(1466))
                        .HasComment("创建时间");
            ...
            modelBuilder.Entity("CasseroleX.Domain.Entities.Ems", b =>
                {
                    ...
                    b.Property<DateTime>("CreateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 8, 8, 9, 41, 16, 17, DateTimeKind.Local).AddTicks(6340))
                        .HasComment("创建时间");
            ...
            modelBuilder.Entity("CasseroleX.Domain.Entities.Sms", b =>
                {
                    ...
                    b.Property<DateTime>("CreateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 8, 8, 9, 41, 16, 19, DateTimeKind.Local).AddTicks(4358))
                        .HasComment("创建时间");
